...
# BOPTESTs eigene Belohnung kennt nur ein Komfortgewicht (siehe logic/boptest_gym_env.py::HVACReward)
# — kein comfort_clip wie bei der früheren CityLearn-Belohnung.
DEFAULT_REWARD = {'w_comfort': 1.0}
